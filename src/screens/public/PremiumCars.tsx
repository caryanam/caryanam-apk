...
export default function PremiumCars() {
  ...
  const { vehicles: all = [], loading, error, refetch, isRefetching } = usePremiumVehicles();
  ...
  const activeBudgetBand = useMemo(() => {
    ...
    return PREMIUM_BUDGET_BANDS.find((b) => b.label === budgetLabel);
  }, [budgetLabel]);
  ...
  return (
    <ScreenWrapper layoutType="public" scrollEnabled={true}>
      <View>
        ...
        <Text style={styles.headerTitle}>Premium Cars Collection — Caryanam</Text>
        <Text style={styles.description}>
          Explore our exclusive, hand-picked collection of premium luxury cars. Certified and verified with direct dealer contact.
        </Text>
      </View>
        ...
        <SafeAreaView style={styles.modalSafeArea}>
          ...
          <FlatList
            ...
            ListHeaderComponent={
              <View style={styles.modalBody}>
                ...
                {/* Custom Price Inputs (if budgetLabel is empty) */}
          ...
          <View style={styles.modalFooter}>
            <Button
              ...
              variant="outline"
              onPress={handleClearFilters}
              style={[styles.modalFooterBtn, { marginRight: 8 }]}
            />
            <Button
              title="Apply Filters"
              onPress={() => setFilterModalVisible(false)}
              style={[styles.modalFooterBtn, { marginLeft: 8 }]}
            />
          </View>
        </SafeAreaView>
      </Modal>
